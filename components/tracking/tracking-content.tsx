    ...
    <div className="flex-1 p-6 space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{format(totalContracted)}</div>
            <p className="text-xs text-muted-foreground mt-1">
              {subcontractsCount} subcontratos activos
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{format(totalCertified)}</div>
            <p className="text-xs text-muted-foreground mt-1">
              {certificatesCount} certificaciones aprobadas
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{format(totalContracted - totalCertified)}</div>
            <p className="text-xs text-muted-foreground mt-1">
                ...
                >
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <div className="text-right ml-4 shrink-0">
                      ...
                      <p className="text-xs text-muted-foreground mt-0.5">
                        {format(stat.certified)} de {format(stat.total_amount)}
                      </p>
                    </div>
                  </div>
                  <div className="space-y-1">
                    ...
                    <div className="flex justify-between text-xs text-muted-foreground">
                      ...
                      <span>Pendiente: {format(stat.total_amount - stat.certified)}</span>
                    </div>
                  </div>
                </Link>
              ))
